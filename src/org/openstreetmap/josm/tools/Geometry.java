...
public final class Geometry {
    ...
    public static EastNorth getSegmentSegmentIntersection(EastNorth p1, EastNorth p2, EastNorth p3, EastNorth p4) {
        ...
        CheckParameterUtil.ensureValid(p1, "p1", EastNorth::isValid);
        CheckParameterUtil.ensureValid(p2, "p2", EastNorth::isValid);
        CheckParameterUtil.ensureValid(p3, "p3", EastNorth::isValid);
        CheckParameterUtil.ensureValid(p4, "p4", EastNorth::isValid);
    ...
    public static boolean angleIsClockwise(EastNorth commonNode, EastNorth firstNode, EastNorth secondNode) {
        ...
        CheckParameterUtil.ensureValid(commonNode, "commonNode", EastNorth::isValid);
        CheckParameterUtil.ensureValid(firstNode, "firstNode", EastNorth::isValid);
        CheckParameterUtil.ensureValid(secondNode, "secondNode", EastNorth::isValid);
